...
if(u8_Alternative_Function>=0 && u8_Alternative_Function<=15 && u8_PinNo<8){
    ...
    case GPIO_PORTA :
        ...
        break;
    case GPIO_PORTB:
            GPIOB ->GPIOx_AFRL &= ~(0b1111<<((u8_PinNo*4)));
            GPIOB ->GPIOx_AFRL |=(u8_Alternative_Function<<((u8_PinNo*4)));
        break;
    case GPIO_PORTC:
            GPIOC ->GPIOx_AFRL &= ~(0b1111<<((u8_PinNo*4)));
            GPIOC ->GPIOx_AFRL |=(u8_Alternative_Function<<((u8_PinNo*4)));
        break;
 }
